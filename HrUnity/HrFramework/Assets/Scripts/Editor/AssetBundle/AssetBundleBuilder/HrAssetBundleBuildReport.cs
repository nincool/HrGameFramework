...
namespace Hr.Editor
{
    public class HrAssetBundleBuildReport
    {
        ...
        //    {
        //        Debug.LogError("Build report path is invalid.");
        //    }

        //    m_BuildReportName = HrFileUtil.GetCombinePath(buildReportPath, BuildReportName);
        //    m_BuildLogName = HrFileUtil.GetCombinePath(buildReportPath, BuildLogName);
