...
namespace Hr.Editor
{
    public class HrBuildInputs
    {
        ...
        [MenuItem("Hr Tools/AssetBundle Tools")]
        private static void OnBuildInputAxes()
        {
            UpdateInputManager();
        }
        ...
        public static void UpdateInputManager()
        {
            ...
            // New axis:
            AddInputAxis(axesProperty, "Mouse ScrollWheel", "", "", "", "", 0, 0, 0.1f, false, false, AxisType.KeyMouseButton, AxisNumber.X);
